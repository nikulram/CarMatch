  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({
        ...
        mileage: "", price: "", description: "", city: "", state: "",
        condition: "New", supportsAR: false, arModel: null
      });
    } catch {
      setError("Failed to list vehicle.");
    }
  };
  ...
  return (
    <MobileContainer>
      <div className="sellcar-container">
        ...
        <form className="sellcar-form" onSubmit={handleSubmit}>
        ...
        <PopupModal
          ...
          message="You must complete Seller Verification before listing a vehicle."
